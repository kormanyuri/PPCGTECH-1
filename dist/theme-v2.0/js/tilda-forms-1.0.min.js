...
var arProduct,optionlabel;for(i in window.tcart.products){product=window.tcart.products[i];arProduct={};optionlabel='';for(j in product){if(j=='options'){for(var o in product[j]){if(product[j][o].option){html+='<input type="hidden" name="tildapayment[products]['+i+']['+j+']['+o+'][option]" value="'+product[j][o].option+'" class="js-tilda-payment">'}
